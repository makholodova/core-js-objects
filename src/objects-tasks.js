...
function sortCitiesArray(arr) {
  ...
  result.sort((a, b) => {
    const res = a.country.charCodeAt(0) - b.country.charCodeAt(0);
    return res === 0 ? a.city.charCodeAt(0) - b.city.charCodeAt(0) : res;
  });
